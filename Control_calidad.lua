...
-- busca monosilabos que NUNCA llevan tilde
	...
	if visible:match("¿") then
		if visible:match("[^%a][Qq]ue[^%a]")
		or visible:match("[^%a][Qq]uien[^%a]")
		or visible:match("[^%a][Qq]uienes[^%a]")
		or visible:match("[^%a][Cc]ual[^%a]")
		or visible:match("[^%a][Cc]uales[^%a]")
		or visible:match("[^%a][Cc]uant[oa][^%a]")
		or visible:match("[^%a][Cc]uant[oa]s[^%a]")
		or visible:match("[^%a][Cc]uanto[^%a]")
		or visible:match("[^%a][Cc]uy[oa][^%a]")
		or visible:match("[^%a][Cc]uy[oa]s[^%a]")
